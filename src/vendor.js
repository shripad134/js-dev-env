/* This file contains references to the vendor libraries
   ...
   in the production build only*. A seperate bundle for vender
   code is useful since it's ublikely to change as often
   ...
   customers having to download a huge JS file anytime a line of
   code changes. they only have to download vendor.js when a vendor
   library changes which should be less frequent.
   Any files that aren't referenced her will be bundles into main.js
